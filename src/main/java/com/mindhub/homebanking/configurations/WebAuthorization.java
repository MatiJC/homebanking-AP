...
class WebAuthorization {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                .antMatchers("/api/accounts","/api/clients/current", "/api/loans").hasAnyAuthority("CLIENT", "ADMIN")
                ...
                .antMatchers("/api/clients/{id}","/api/accounts/{id}").hasAnyAuthority("CLIENT", "ADMIN")
